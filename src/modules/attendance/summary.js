...
class Summary {
    ...
    getSummary = async (date) => {
        ...
        const QUERY = `
            SELECT d.ID, d.NAME AS DEPARTMENTS, COALESCE(h.Presen, 0) - COALESCE(n.Night_Shift, 0) AS PRESENT, COALESCE(a.Absent, 0) AS ABSENT, t.Total AS TOTAL, COALESCE(n.Night_Shift, 0) AS NIGHT_SHIFT 
