...
class Worker {
    ...
    add = async (id, name, department_id, department_type, project_id, input_by) => {
        ...
        const QUERY_INSERT = `INSERT INTO ${TABLES.LIST_WORKER.TABLE} (${TABLES.LIST_WORKER.COLUMN.ID}, ${TABLES.LIST_WORKER.COLUMN.NAME}, ${TABLES.LIST_WORKER.COLUMN.INPUT_DATE}, 
        ${TABLES.LIST_WORKER.COLUMN.DEPARTMENT_ID}, ${TABLES.LIST_WORKER.COLUMN.PROJECT_ID}, ${TABLES.LIST_WORKER.COLUMN.INPUT_BY}) VALUES (?, ?, NOW(), ?, ?, ?)`

        const QUERY_INSERT_SUB = `INSERT INTO ${TABLES.LIST_WORKER.TABLE} 
        (${TABLES.LIST_WORKER.COLUMN.ID}, ${TABLES.LIST_WORKER.COLUMN.NAME}, ${TABLES.LIST_WORKER.COLUMN.INPUT_DATE}, 
        ...
        VALUES (?, ?, NOW(), ?, ?, ?, (SELECT CD.${TABLES.COMPANY_DEPARTMENTS.COLUMN.ID} FROM ${TABLES.COMPANY_DEPARTMENTS.TABLE} AS CD 
