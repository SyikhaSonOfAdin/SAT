...
class SubDepartment {
    add = async (departmentId, userId, name) => {
        ...
        const QUERY = [
            `INSERT INTO ${TABLES.LIST_SUB_DEPARTMENT.TABLE} (${TABLES.LIST_SUB_DEPARTMENT.COLUMN.DEPARTMENT_ID}, ${TABLES.LIST_SUB_DEPARTMENT.COLUMN.INPUT_BY}, ${TABLES.LIST_SUB_DEPARTMENT.COLUMN.NAME}, ${TABLES.LIST_SUB_DEPARTMENT.COLUMN.INPUT_DATE})
            VALUES (?,?,?, NOW())`
        ]
